  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Report Trip</li>
      </ol>
    </nav>
    ...
    <div class="card">
      <div class="card-body">
        <div class="text-nowrap">
          <form id="formAccountSettings" method="GET" action="{{ route('backend.dash.report.trip.index') }}">
      ...
      <div class="card mt-4">
        <div class="card-body">                
          <div class="demo-inline-spacing">
            <a href="{{ route('backend.dash.report.trip.download-pdf', $buildQ) }}" class="btn btn-outline-primary">Download Rekap PDF</a>
          </div>
        </div>
      </div>
    @endif
