...
@section('content')
  <div class="container-xxl flex-grow-1 container-p-y">
    ...
    <h5 class="mt-4 mb-4">Create Driver</h5>
    <form action="{{ Route('backend.drivers.store') }}" method="POST" id="addForm" enctype="multipart/form-data">
      @csrf
      <div class="card mb-4">
        <div class="card-body">
          <div class="row">
          ...
          <div class="row">
            <div class="col-md-4 mb-3">
              ...
              <input class="form-control" type="text" name="bank_name" base_error="Err_bank_name">
              <div id="Err_bank_name" class="text-danger"></div>
            </div>
            <div class="col-md-4 mb-3">
              <label class="form-label">Bank Card Holder</label>
              <input class="form-control" type="text" name="bank_card_holder" base_error="Err_bank_card_holder">
              <div id="Err_bank_card_holder" class="text-danger"></div>
            </div>
            <div class="col-md-4 mb-3">
              <label class="form-label">Bank Account Number</label>
              <input class="form-control" type="text" name="bank_account_number" base_error="Err_bank_account_number">
